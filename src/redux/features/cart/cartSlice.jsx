    ...
    reducers:{
        addToCart:(state,action) => {
          ...
          const isExist = state.products.find(
            (product) => product._id === action.payload._id && product.selectedSize === action.payload.selectedSize
        );
        ...
        updateQuantity:(state, action)=>{
            const products = state.products.map((product)=>{
                if(product._id === action.payload.id && product.selectedSize === action.payload.selectedSize){
